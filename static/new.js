...
// helper method
// used in renderSections, renderSubsection, createSectionsPanel
...
function renderSubsection(subsection, textPanel, visualsPanel) {
    ...
    subsectionDiv.innerHTML = `<div class="section-header">${subsection.title}</div>`;

    // Render paragraph for the subsection
    subsection.paragraphs.forEach(paragraph => {
        renderParagraph(paragraph, subsectionDiv.querySelector('.text-panel'), subsectionDiv.querySelector('.visual-panel'));
    });

    textPanel.appendChild(subsectionDiv);
}

// Function to render lists (unordered or ordered)
...
// Add this function to render individual sections
...
// Add this new function for creating citation popups
